        ...
        <div class="kt-grid kt-grid--hor kt-grid--root">
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                <!-- begin:: Header -->
                    ...
                    <!-- begin:: Footer -->
                    <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop footer_position_fixed_style" id="kt_footer">
                        <div class="kt-container  kt-container--fluid ">
                            <div class="kt-footer__copyright">
								{{ _lang('Copyright') }} &copy; {{ date('Y').' '.get_option('company_name') }}
								<P class="current_version">{{ _lang('Version').' '. get_option('current_version')}}</P>
                            </div>
                        </div>
                    </div>
                    <!-- end:: Footer -->
